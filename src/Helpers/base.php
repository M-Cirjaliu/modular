...
if (!function_exists('app')) {
     ...
     *
     * @return mixed|\Laralite\Foundation\Application
     */
...
if (!function_exists('redirect')) {
     ...
     *
     * @return \Yggdrasil\Http\Redirector|\Illuminate\Http\RedirectResponse
     */
...
if (!function_exists('manager')) {
     ...
     *
     * Optionally passing a module parameter will get the module
     *
     * @param Modular\Module\Module|null $module
     *
     * @return \Laralite\Foundation\Application|mixed
     */
    function manager($module = null)
    {
        if (is_null($module)) {
            return app('manager');
        }

        return app('manager')->get($module);
    }
}
